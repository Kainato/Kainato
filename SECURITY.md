...
Se você descobrir uma vulnerabilidade de segurança, **não abra uma issue pública**. Em vez disso, envie um relatório privado para: **[caiocaladaraujo.dev@gmail.com](mailto:caiocaladaraujo.dev@gmail.com)** com o título "[SEGURANÇA-READ-ME]".
...
**Nota:** Apenas a versão mais recente (branch `main`) recebe atualizações de segurança. Recomendamos manter-se atualizado com a versão mais recente.
